...
project_directory = 'C:/Users/hp/kifiya_acadamy_week7/kifiya_week7_assignment'

# Construct the full path to the .env file inside the 'scripts' folder
dotenv_path = os.path.join(project_directory, 'scripts', '.env')
